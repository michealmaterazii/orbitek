    ...
    <main className="min-h-screen bg-[#010108] text-white flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-xs tracking-widest" style={{ fontFamily: "'Rajdhani', sans-serif", color: 'rgba(0,255,255,0.6)' }}>◈ CREATE YOUR ACCOUNT ◈</p>
        </div>
        ...
        <div className="p-8" style={{ border: '1px solid rgba(0,255,255,0.1)', background: 'rgba(255,255,255,0.02)', backdropFilter: 'blur(20px)' }}>
          ...
          <div className="space-y-5">
            ...
            {/* Submit */}
            <button className="w-full py-4 font-black text-xs tracking-widest mt-2 transition-all duration-300 hover:opacity-90" style={{
            ...
            <div className="flex items-center gap-4 py-2">
              ...
              <span className="text-xs" style={{ fontFamily: "'Rajdhani', sans-serif", color: 'rgba(255,255,255,0.2)' }}>ALREADY HAVE AN ACCOUNT?</span>
              <div className="flex-1 h-px" style={{ background: 'rgba(255,255,255,0.05)' }} />
            </div>

            {/* Login link */}
            <a href="/login" className="block w-full py-4 text-center font-black text-xs tracking-widest transition-all duration-300 hover:border-cyan-400 hover:text-cyan-400" style={{
              fontFamily: "'Orbitron', sans-serif",
