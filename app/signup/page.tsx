      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="p-8" style={{ border: '1px solid rgba(0,255,255,0.1)', background: 'rgba(255,255,255,0.02)', backdropFilter: 'blur(20px)' }}>
          <div className="space-y-5">
            ...
            <a href="/login" className="block w-full py-4 text-center font-black text-xs tracking-widest transition-all duration-300 hover:border-cyan-400 hover:text-cyan-400"
