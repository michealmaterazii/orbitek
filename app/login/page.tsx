    ...
    <main className="min-h-screen bg-[#010108] text-white flex items-center justify-center px-4 py-8">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-3 text-xs tracking-widest" style={{ fontFamily: "'Rajdhani', sans-serif", color: 'rgba(0,255,255,0.6)' }}>◈ WELCOME BACK ◈</p>
        </div>
        ...
        <div className="p-6 md:p-8" style={{ border: '1px solid rgba(0,255,255,0.1)', background: 'rgba(255,255,255,0.02)', backdropFilter: 'blur(20px)' }}>
          <div className="space-y-4">
            ...
            {error && (
              <div className="px-4 py-3 text-xs text-red-400" style={{ border: '1px solid rgba(255,0,0,0.2)', background: 'rgba(255,0,0,0.05)', fontFamily: "'Rajdhani', sans-serif" }}>
                {error}
              </div>
            )}
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a href="#" className="text-xs" style={{ fontFamily: "'Rajdhani', sans-serif", color: 'rgba(0,255,255,0.5)' }}>FORGOT?</a>
              </div>
              <div className="flex items-center gap-3 px-4 py-3" style={{ border: '1px solid rgba(0,255,255,0.2)', background: 'rgba(0,255,255,0.02)' }}>
            ...
            <div className="flex items-center gap-3 py-1">
              ...
              <span className="text-xs" style={{ fontFamily: "'Rajdhani', sans-serif", color: 'rgba(255,255,255,0.2)', fontSize: '10px' }}>DON'T HAVE AN ACCOUNT?</span>
              <div className="flex-1 h-px" style={{ background: 'rgba(255,255,255,0.05)' }} />
            </div>

            <a href="/signup" className="block w-full py-4 text-center font-black text-xs tracking-widest transition-all hover:border-cyan-400 hover:text-cyan-400"
